...
public class PickupFragment extends Fragment {
    ...
    private PickUpActionListener actionListener;
    ...
    private void onNextClick() {
        try {
            validateInput();
            actionListener.onNextOfPickupClick(
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof PickUpActionListener) {
            actionListener = (PickUpActionListener) context;
        } else {
    ...
    public interface PickUpActionListener {
        void onNextOfPickupClick(String floorLevel, boolean elevator, String parkingDistance, String weight, String area, String extra);
    }
}
