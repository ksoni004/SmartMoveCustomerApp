...
public class DropFragment extends Fragment {
    ...
    private void onNextClick() {
        try {
            validateInput();
            actionListener.onNextOfDropClick(
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof DropActionListener) {
            actionListener = (DropActionListener) context;
        } else {
    ...
    public interface DropActionListener {
        void onNextOfDropClick(String floorLevel, boolean elevator, String parkingDistance, String weight, String area, String extra);
    }
}
